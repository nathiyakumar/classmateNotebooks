/**
 * @flow
 * @relayHash eccc1a36ef06874fe3a83f208cfd6b23
 */
...
export type AdminDashboardOrdersApprovedOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersApprovedOrdersQueryResponse = {|
  +ordersApproved: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersApprovedOrdersQuery = {|
  variables: AdminDashboardOrdersApprovedOrdersQueryVariables,
  response: AdminDashboardOrdersApprovedOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersApprovedOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersApprovedOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersApprovedOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersApprovedOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersApproved(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '206dcbd5e03dfed6ec7df208934911f4';
module.exports = node;
