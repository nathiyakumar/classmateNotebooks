/**
 * @flow
 * @relayHash 0bb3c4ac25f9459e67942762b0b4fc34
 */
...
export type AdminDashboardOrdersDeliveredOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersDeliveredOrdersQueryResponse = {|
  +adminDeliveredOrdersLines: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersDeliveredOrdersQuery = {|
  variables: AdminDashboardOrdersDeliveredOrdersQueryVariables,
  response: AdminDashboardOrdersDeliveredOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersDeliveredOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersDeliveredOrdersQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "adminDeliveredOrdersLines",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersDeliveredOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersDeliveredOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminDeliveredOrdersLines(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '0a62401454b76abb706ece8b69b10490';
module.exports = node;
