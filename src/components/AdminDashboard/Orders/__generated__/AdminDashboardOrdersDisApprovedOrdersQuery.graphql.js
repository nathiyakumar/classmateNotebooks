/**
 * @flow
 * @relayHash c918286e0b19074ce9872f55fe0bf379
 */
...
export type AdminDashboardOrdersDisApprovedOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersDisApprovedOrdersQueryResponse = {|
  +disapprovedOrders: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersDisApprovedOrdersQuery = {|
  variables: AdminDashboardOrdersDisApprovedOrdersQueryVariables,
  response: AdminDashboardOrdersDisApprovedOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersDisApprovedOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersDisApprovedOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersDisApprovedOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersDisApprovedOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  disapprovedOrders(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '5970624931d598874c4c4c6a20988bb1';
module.exports = node;
