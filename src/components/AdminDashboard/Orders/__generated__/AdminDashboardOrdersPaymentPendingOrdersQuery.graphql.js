/**
 * @flow
 * @relayHash 1365eea25398d5f97c347ad92a1163c4
 */
...
export type AdminDashboardOrdersPaymentPendingOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersPaymentPendingOrdersQueryResponse = {|
  +failedPayment: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersPaymentPendingOrdersQuery = {|
  variables: AdminDashboardOrdersPaymentPendingOrdersQueryVariables,
  response: AdminDashboardOrdersPaymentPendingOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersPaymentPendingOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersPaymentPendingOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersPaymentPendingOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersPaymentPendingOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  failedPayment(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '01390e27501ccf0a6c9622f492c41006';
module.exports = node;
