/**
 * @flow
 * @relayHash d0f2dc246dd9ff9317a737027edfdd2b
 */
...
export type AdminDashboardOrdersPrintingOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersPrintingOrdersQueryResponse = {|
  +adminPrintingOrdersLines: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersPrintingOrdersQuery = {|
  variables: AdminDashboardOrdersPrintingOrdersQueryVariables,
  response: AdminDashboardOrdersPrintingOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersPrintingOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersPrintingOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersPrintingOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersPrintingOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminPrintingOrdersLines(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '1f7083c4cf874918c8268a79c1349990';
module.exports = node;
