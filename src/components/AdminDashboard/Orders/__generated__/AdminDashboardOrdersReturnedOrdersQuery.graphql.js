/**
 * @flow
 * @relayHash f5d75146726f7b695858b27205b17e5f
 */
...
export type AdminDashboardOrdersReturnedOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersReturnedOrdersQueryResponse = {|
  +adminReturnsOrdersLines: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersReturnedOrdersQuery = {|
  variables: AdminDashboardOrdersReturnedOrdersQueryVariables,
  response: AdminDashboardOrdersReturnedOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersReturnedOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersReturnedOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersReturnedOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersReturnedOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminReturnsOrdersLines(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '7237806bb03a9204eb7e58e3a3c6ccee';
module.exports = node;
