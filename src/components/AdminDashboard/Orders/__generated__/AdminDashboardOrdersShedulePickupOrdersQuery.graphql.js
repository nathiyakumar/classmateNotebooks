/**
 * @flow
 * @relayHash 43c7d675dd92190ede34f4a95d35d6d8
 */
...
export type AdminDashboardOrdersShedulePickupOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersShedulePickupOrdersQueryResponse = {|
  +adminPickupScheduledOrdersLines: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersShedulePickupOrdersQuery = {|
  variables: AdminDashboardOrdersShedulePickupOrdersQueryVariables,
  response: AdminDashboardOrdersShedulePickupOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersShedulePickupOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersShedulePickupOrdersQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "adminPickupScheduledOrdersLines",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersShedulePickupOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersShedulePickupOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminPickupScheduledOrdersLines(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '119df39e066959bf5ad6b1cf5e7f741d';
module.exports = node;
