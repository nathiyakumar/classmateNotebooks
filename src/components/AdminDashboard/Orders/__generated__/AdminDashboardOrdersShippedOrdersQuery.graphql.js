/**
 * @flow
 * @relayHash d7e5531f358976e868c74b1a5abe5cb4
 */
...
export type AdminDashboardOrdersShippedOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersShippedOrdersQueryResponse = {|
  +adminShippedOrdersLines: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersShippedOrdersQuery = {|
  variables: AdminDashboardOrdersShippedOrdersQueryVariables,
  response: AdminDashboardOrdersShippedOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersShippedOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersShippedOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersShippedOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersShippedOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminShippedOrdersLines(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '7bd83e19ed16ec459ed310e9f7f74218';
module.exports = node;
