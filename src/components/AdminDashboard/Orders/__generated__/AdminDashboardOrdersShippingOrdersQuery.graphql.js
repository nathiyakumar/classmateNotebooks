/**
 * @flow
 * @relayHash c5b543a7faf66188a1022681a3c53de6
 */
...
export type AdminDashboardOrdersShippingOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersShippingOrdersQueryResponse = {|
  +adminOrdersListBasedOnShipping: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersShippingOrdersQuery = {|
  variables: AdminDashboardOrdersShippingOrdersQueryVariables,
  response: AdminDashboardOrdersShippingOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersShippingOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersShippingOrdersQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "adminOrdersListBasedOnShipping",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersShippingOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersShippingOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  adminOrdersListBasedOnShipping(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '088f44a406109203ccd0c7076543b646';
module.exports = node;
