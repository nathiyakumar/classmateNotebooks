/**
 * @flow
 * @relayHash fd7282da01ff1a98e44dca1096491b7b
 */
...
export type AdminDashboardOrdersWaitingForApprovalOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type AdminDashboardOrdersWaitingForApprovalOrdersQueryResponse = {|
  +ordersToBeApproved: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type AdminDashboardOrdersWaitingForApprovalOrdersQuery = {|
  variables: AdminDashboardOrdersWaitingForApprovalOrdersQueryVariables,
  response: AdminDashboardOrdersWaitingForApprovalOrdersQueryResponse,
|};
*/


/*
query AdminDashboardOrdersWaitingForApprovalOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "AdminDashboardOrdersWaitingForApprovalOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "AdminDashboardOrdersWaitingForApprovalOrdersQuery",
    "id": null,
    "text": "query AdminDashboardOrdersWaitingForApprovalOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersToBeApproved(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      id\n      shippingStatus\n      lines {\n        id\n        order {\n          id\n          orderId\n          created\n          total\n          userEmail\n          shippingAddress {\n            firstName\n            phone\n            id\n          }\n          status\n          payments {\n            gateway\n            id\n            chargeStatus\n          }\n        }\n        productName\n        productSku\n        quantity\n        vendor {\n          id\n          vendor {\n            firstName\n            mobileNumber\n            id\n          }\n        }\n        lineShipping(first: 100) {\n          edges {\n            node {\n              shippingStatus\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '93d436d27c4d55c1e7e7cfb3f72694b2';
module.exports = node;
