/**
 * @flow
 * @relayHash bb68572adaa46ce8bf30a373a2a5b928
 */
...
export type AdminProductsListQueryVariables = {||};
export type AdminProductsListQueryResponse = {|
...
export type AdminProductsListQuery = {|
  variables: AdminProductsListQueryVariables,
  response: AdminProductsListQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    ...
    "name": "AdminProductsListQuery",
    "id": null,
    "text": "query AdminProductsListQuery {\n  adminProductsList {\n    id\n    publicationDate\n    isPublished\n    productType {\n      id\n      name\n    }\n    name\n    description\n    category {\n      id\n      name\n    }\n    isFeatured\n    isActive\n    masterSku\n    price\n    updatedAt\n    chargeTaxes\n    quantity\n    weight\n    units\n    slug\n    images(first: 1) {\n      edges {\n        node {\n          url\n          id\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'd126859cd21a7cc73425a0e0b4937dc9';
module.exports = node;
