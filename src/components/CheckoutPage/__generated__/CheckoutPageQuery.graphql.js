/**
 * @flow
 * @relayHash eec642d2664bb8cd70077e9bbab8d1e5
 */
...
export type CheckoutPageQueryVariables = {|
  checkoutId?: ?string
|};
export type CheckoutPageQueryResponse = {|
  +getCheckout: ?{|
    +id: string,
    +lines: ?$ReadOnlyArray<?{|
      +id: string,
...
export type CheckoutPageQuery = {|
  variables: CheckoutPageQueryVariables,
  response: CheckoutPageQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    ...
    "name": "CheckoutPageQuery",
    "id": null,
    "text": "query CheckoutPageQuery(\n  $checkoutId: ID\n) {\n  getCheckout(checkoutId: $checkoutId) {\n    id\n    lines {\n      id\n      quantity\n      variant {\n        id\n        sku\n        name\n        price\n        costPrice\n        priceOverride\n        images {\n          url\n          id\n        }\n        stockQuantity\n        product {\n          productType {\n            name\n            id\n          }\n          category {\n            id\n            name\n          }\n          id\n        }\n      }\n    }\n    subtotalPrice\n    totalPrice\n    checkoutQuantity\n    voucherCode\n    shippingPrice\n    discountName\n    discountAmount\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '0c4d9c387a03a12859dd2a0cb11f8405';
module.exports = node;
