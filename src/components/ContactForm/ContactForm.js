...
import CreateFeedbackMutation from '../../mutations/CreateFeedbackMutation';
...
class ContactForm extends React.Component {
    ...
    handleSignupDetails = (field, e) => {
        ...
        if(field === "phone_number"){
            let data = e.target.validity.valid ? e.target.value : this.state.phone_number;
            this.setState({
                [field]: data
            })
        } else {
    ...
    submitFeedback = () => {
        ...
        if(this.state.name === "" || this.state.name === undefined || this.state.name === null){
            cogoToast.error("Please Fill Your Name", { position: 'top-center'});
        } else if(email_isvalid === false){
            cogoToast.error("Please Fill Valid EmailID", { position: 'top-center'});
        }else if(this.state.phone_number === "" || this.state.phone_number === undefined || this.state.phone_number === null){
        ...
        }else if(this.state.state === "" || this.state.state === undefined || this.state.state === null){
            cogoToast.error("Please Fill State", { position: 'top-center'});
        }else if(this.state.city === "" || this.state.city === undefined || this.state.city === null){
            cogoToast.error("Please Fill City", { position: 'top-center'});
        }else if(this.state.comment === "" || this.state.comment === undefined || this.state.comment === null){
            cogoToast.error("Please Fill Comment", { position: 'top-center'});
        }else if(this.state.inquiry_types === "" || this.state.inquiry_types === undefined || this.state.inquiry_types === null){
            cogoToast.error("Please Fill Inquiry Types", { position: 'top-center'});
        }

        else if(this.state.inquiry_types ==="order_issue"  &&  this.state.order_id === ""){
                cogoToast.error("Please Fill Order Id", { position: 'top-center'});
        }
        else {

                let scope = this;

                CreateFeedbackMutation(this.state,function (response) {
                    if(response.createFeedback !== null){
                        cogoToast.success(response.createFeedback.message, { position: 'top-center'});
                        scope.setState({
                            city: '',
                            state: '',
                            email: '',
            ...
            <div>
                ...
                <Box mt={1}>
                    <div className="contactRoot" >
                        ...
                        {
                            this.state.submit_form === false ?
                                (
                                    <div style={{position: "relative"}}>
                                        <Grid container>
                                            <Grid item xs={12}>
                                                <Box p={4} className="Contact_Title"  >
                                                    <Typography variant="h4" style={{textAlign: 'center'}}>Contact Us</Typography>
                                                    <Typography style={{textAlign: 'center', fontFamily: "'Poppins', sans-serif"}}><b>For Business inquiry and feedbacks</b> </Typography>
                                                </Box>
                                            </Grid>
                                                ...
                                                <Grid item xs={12} sm>
                                                    ...
                                                    <FormControl style={{display: ' flex'}}>
                                                        <div className="form-group">
                                                            <label htmlFor="comment">Inquiry Type</label>&nbsp;&nbsp;
                                                            <FormControl variant="filled" className="form-control">
                                                                <InputLabel id="demo-simple-select-filled-label">Select Inquiry Type</InputLabel>
                                                                <Select
                                                                    labelId="demo-simple-select-filled-label"
                                                                    id="demo-simple-select-filled"
                                                                    value={this.state.inquiry_types}
                                                                    // onChange={handleChange}
                                                                    onChange={this.handleSignupDetails.bind(this, "inquiry_types")}
                                                                >
                                                                    <MenuItem value="business_inquiry">Business Related Inquiry</MenuItem>
                                                                    <MenuItem value="order_issue">Order Related Inquiry</MenuItem>

                                                                </Select>
                                                            </FormControl>
                                                        </div>
                                                        {
                                                            this.state.inquiry_types === "order_issue"?   <div className="form-group">
                                                                <label htmlFor="order_id">Order Id</label>&nbsp;&nbsp;
                                                                <input type="number" className="form-control" name="order_id" id="order_id"
                                                                       placeholder="Enter Order Id"
                                                                       onChange={this.handleSignupDetails.bind(this, "order_id")}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="name" id="name"
                                                                   ...
                                                                   onChange={this.handleSignupDetails.bind(this, "name")}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input type="email" className="form-control" name="email" id="email"
                                                                   ...
                                                                   onChange={this.handleSignupDetails.bind(this, "email")}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="phoneNumber"
                                                                   ...
                                                                   // onInput={this.handleSignupDetails.bind(this, "phone_number")}
                                                                   onChange={this.handleSignupDetails.bind(this, "phone_number")}
                                                                   value={this.state.phone_number}
                                                                // onInput={(e) => this.handleSignupDetails('phone_number', e)}
                                                            />
                                                        </div>
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="state" id="state"
                                                                   ...
                                                                   onChange={this.handleSignupDetails.bind(this, "state")}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="city" id="city"
                                                                   ...
                                                                   onChange={this.handleSignupDetails.bind(this, "city")}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <textarea className="form-control" name="comment" id="comment"
                                                                      ...
                                                                      rows="4" cols="50"
                                                                      onChange={this.handleSignupDetails.bind(this, "comment")}
                                                                      value={this.state.comment}
                                                            />
                                                        </div>

                                                        <Grid item xs={6} sm>
                                                            <Button type="submit" style={{backgroundColor: '#FF6733', color: '#fff'}}
                                                                    onClick={this.submitFeedback}>Submit
                                                            </Button>
                                                        </Grid>
                                                    </FormControl>
                                                </Grid>
                                    ...
                                    <div className="contackform_success_msg">
                                        <div className="wrapper">
                                            <div className="screen">
                                                ...
                                                <svg className="plane" viewBox="0 0 139 139">
                                                    ...
                                                    <path fill="#FFF" stroke="url(#a)" stroke-width="2"
                                                ...
                                                <p className="message">Thankyou for your Feedback!</p>
                                                <Link to={"/"}><h2 className="button">Go Home</h2></Link>
