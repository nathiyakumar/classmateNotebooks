...
import {addNotebookImages, ClearAllDesigns, getNotebookImages, SetAllCanvas} from "../../../../Actions";
...
const GetSKUBySpecification = graphql`
        query DesignUploadNotebookSkuQuery($size:String , $bindingType:String , $pages:String , $rulingType:String ) {
...
class DesignUpload extends React.Component{
    ...
    render() {
        return (
            <div className="mobile_spec_field_component">
                ...
                <Typography className='question' style={{marginBottom:'3%'}}> 6) Upload Images</Typography>
                    <div className="upload-page">
                        ...
                        </LoadingScreen>
                        {
                            this.state.files.length > 0 ? (
                                <span style={{display: "flex",marginTop:'3%'}}><img src={noteIcon} alt="note" style={{width: "20px", paddingRight: '10px'}}/>
                                    <Typography variant="h6" className="noteTxt">
                                        <span>Tap on the </span>
                                        <Icon style={{fontSize: '20px'}} className="notemenu">
                                            <MoreHorizIcon style={{color: '#000', width: '1em', height: '0.7em',}}/>
                                        </Icon>
                                        <span> to edit design</span>
                                    </Typography>
                                </span>
                            ): (
                                <p className="image_upload_warning" style={{margin: '15px 0px',display:'none'}} >Note: Images size should not
                                    exceed 2MB.</p>
                            )
                        }
                ...
                <div className="mobile_design_field_footer">
                    <Button onClick={this.back} style={{padding: ' 9px 8px'}}>Back</Button>
                    <button disabled={true} onClick={this.saveAndContinue} className="placeorder-btn" >Checkout</button>
...
export default compose(
    withRouter,
    connect(mapStateToProps, mapDispatchToProps))(DesignUpload)
