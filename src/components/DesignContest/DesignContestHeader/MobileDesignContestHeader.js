...
import './MobileDesignContestHeader.css';
...
class MobileDesignContestHeader extends Component {
                    ...
                    AuthProviderData => {
                        ...
                        return(
                            <div className="mobile_navbar">
                                ...
                                {/*    <div className="geek1">Amidst COVID-19 restrictions, your delivery would be delayed*/}
                                        ...
                                        <div className="mobile_category_list">
                                            <List
                                                ...
                                                <ListItem button style={{borderBottom:'1px solid #ffffff6b'}} onClick={() => {
                                                    ...
                                                    <Link to="/">
                                                        <ListItemText primary="Design Challenge" />
                                                    </Link>
                                                </ListItem>
                                                <ListItem button style={{borderBottom:'1px solid #ffffff6b'}} onClick={() => {
                                                    this.toggleDrawer('top')}}>
                                                    <Link to="/classmate-customised-notebooks/select-pages"
                                                          // onClick={()=>this.sendEventToGA('design notebook','CustomizerHeader')}
                                                    >
                                                        <ListItemText id="main_menu_make_your_notebook" primary="How it Works" />
                                                    </Link>
                                                </ListItem>
                                                ...
                                                {/*        <ListItemText id="main_menu_limited_edition_products" primary="Limited Edition Products" />*/}
                                                {/*    </Link>*/}
                                                {/*</ListItem>*/}
...
)(withStyles(styles)(MobileDesignContestHeader));
