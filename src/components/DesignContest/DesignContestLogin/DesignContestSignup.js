...
import './DesignContestSignup.css';
...
class DesignContestSignupSignup extends React.Component{
            ...
            <div>
                <div id='signUpContainer_design_contest'>
                    <div id='signUpFormContainer_design_contest'>
                        ...
                        <form id="signUpForm_design_contest" autoComplete="off">
                            {
                                this.state.showOtpField === false?
                                    <div>
                                        <div className="login_first_field">
                                            <h4 className="login_title_design_contest">Register for the Contest</h4>
                                            <FormInput type="text" placeholder="eg. John Doe" name="First Name"
                                                       value={this.state.firstname} onChange={(e)=>this.handleSignupDetails('firstname',e)} />
                                            <FormInput type="email" placeholder="John.Doe@example.com" name="Email-ID"
                                                       value={this.state.email} onChange={(e)=>this.handleSignupDetails('email',e)} />
                                            <FormInput type="text" placeholder="0000000000" name=" Mobile Number"
                                        ...
                                        <div className="loginform_action_design_contest">
                                            <button type="button" className="continue_btn_design_contest" onClick={this.SubmitSignupForm}><span>Continue</span><Icon
                                                className="fa fa-arrow-right " style={{fontSize: 16, margin: "-3px 10px"}}/></button>
                                            <p className="new_customer_link_design_contest" onClick={() => this.props.handleFormChange('login')}>Already have account? Login</p>
...

                            {
                                this.state.showOtpField === true?(
                                        <div className="login_second_field_otp">
                                            ...
                                            <div className="loginform_action_design_contest">
                                                <button type="button" className="continue_btn_design_contest" onClick={this.verifyOtp}><span>Continue</span><Icon
                                                    className="fa fa-arrow-right " style={{fontSize: 16, margin: "-3px 10px"}}/></button>
                                                <p className="new_customer_link_design_contest" onClick={() => this.props.handleFormChange('login')}>Existing User? Register</p>
...
export default connect(mapStateToProps,mapDispatchToProps)(DesignContestSignupSignup);
