/**
 * @flow
 * @relayHash de6cbb6e5e431013a3cc3dbd4431ebf2
 */
...
export type MyOrderPageQueryVariables = {|
  userId: string
|};
export type MyOrderPageQueryResponse = {|
  ...
  |}>
|};
export type MyOrderPageQuery = {|
  variables: MyOrderPageQueryVariables,
  response: MyOrderPageQueryResponse,
|};
*/


/*
query MyOrderPageQuery(
  $userId: ID!
) {
...
return {
  ...
  "params": {
    ...
    "name": "MyOrderPageQuery",
    "id": null,
    "text": "query MyOrderPageQuery(\n  $userId: ID!\n) {\n  ordersBasedOnUser(userId: $userId) {\n    id\n    orderId\n    created\n    total\n    userEmail\n    status\n    isPaymentSuccessful\n    payments {\n      gateway\n      id\n      chargeStatus\n      paymentOrderId\n      total\n    }\n    shippingAddress {\n      id\n      firstName\n      lastName\n      companyName\n      city\n      country {\n        code\n        country\n      }\n      postalCode\n      phone\n    }\n    billingAddress {\n      id\n      firstName\n      lastName\n      companyName\n      city\n      country {\n        code\n        country\n      }\n      postalCode\n      phone\n    }\n    shippingMethod {\n      name\n      shippingTotal\n      id\n    }\n    voucher {\n      name\n      code\n      id\n    }\n    discountName\n    discountAmount\n    lines(first: 100) {\n      edges {\n        node {\n          id\n          weight\n          productName\n          quantity\n          unitPrice\n          unitPriceNet\n          unitPriceGross\n          taxRate\n          vendor {\n            vendor {\n              firstName\n              email\n              mobileNumber\n              id\n            }\n            id\n          }\n          lineShipping(first: 100) {\n            edges {\n              node {\n                shippingStatus\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '0fdde44f195ce1fe398d148fd80d08b5';
module.exports = node;
