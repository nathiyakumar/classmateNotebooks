...
const arrowDown = "https://cdn.classmateshop.co.in/live/Front-Assets/FrontEnd/Arrow_down.svg"
                            ...
                            <div className="MainNav">
                                <div style={{
                                    ...
                                    <marquee className="marq" bgcolor="Green" direction="left" loop="" >
                                        <div className="geek1">
                                            {/* Amidst COVID-19 restrictions, your delivery would be
                                    ...
                                    <AppBar position="static" className="desktopAppBar">
                                        <Toolbar className="toolBar">
                                            ...
                                            {/*</div>*/}
                                            <div className="NavBtn">
                                                <div className="BtnContent" onClick={() => {
                                ...
                                <ul className="nav__menu">
                                    ...
                                    <li className="nav__menu-item">
                                        <Link to="/classmate-school-and-office-stationery-products"
                                            ...
                                            <span className="menuList" id="main_menu_limited_edition_products">Buy Stationery Products</span>
                                        </Link>
                                    </li>
                                    <li className="nav__menu-item">
