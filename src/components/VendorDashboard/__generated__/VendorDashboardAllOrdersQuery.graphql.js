/**
 * @flow
 * @relayHash 237d1fa1272862bdfd72a12a37e19064
 */
...
export type VendorDashboardAllOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardAllOrdersQueryResponse = {|
  +ordersBasedOnVendorAll: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardAllOrdersQuery = {|
  variables: VendorDashboardAllOrdersQueryVariables,
  response: VendorDashboardAllOrdersQueryResponse,
|};
*/


/*
query VendorDashboardAllOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardAllOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "VendorDashboardAllOrdersQuery",
    "id": null,
    "text": "query VendorDashboardAllOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorAll(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'b9044056c3b71a4f1cfa6e859d29ffa5';
module.exports = node;
