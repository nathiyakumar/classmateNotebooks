/**
 * @flow
 * @relayHash 2fff330b70a598939dad36775ba183c4
 */
...
export type VendorDashboardAllPrintingOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardAllPrintingOrdersQueryResponse = {|
  +ordersBasedOnPrinting: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardAllPrintingOrdersQuery = {|
  variables: VendorDashboardAllPrintingOrdersQueryVariables,
  response: VendorDashboardAllPrintingOrdersQueryResponse,
|};
*/


/*
query VendorDashboardAllPrintingOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardAllPrintingOrdersQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "VendorDashboardAllPrintingOrdersQuery",
    "id": null,
    "text": "query VendorDashboardAllPrintingOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnPrinting(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '574a33e81c9aace244390d9ae44a906a';
module.exports = node;
