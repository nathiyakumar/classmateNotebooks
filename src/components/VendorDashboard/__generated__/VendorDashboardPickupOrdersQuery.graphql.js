/**
 * @flow
 * @relayHash 72204bdc2cb4bb361009456299871962
 */
...
export type VendorDashboardPickupOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardPickupOrdersQueryResponse = {|
  +ordersBasedOnVendorPickup: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardPickupOrdersQuery = {|
  variables: VendorDashboardPickupOrdersQueryVariables,
  response: VendorDashboardPickupOrdersQueryResponse,
|};
*/


/*
query VendorDashboardPickupOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardPickupOrdersQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "ordersBasedOnVendorPickup",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "VendorDashboardPickupOrdersQuery",
    "id": null,
    "text": "query VendorDashboardPickupOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorPickup(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '9c181340fa7f87cf966f220008da4e43';
module.exports = node;
