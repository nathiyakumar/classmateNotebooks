/**
 * @flow
 * @relayHash ec74832ec9ae66df0352da2ccd802e1a
 */
...
export type VendorDashboardPickupSheduledQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardPickupSheduledQueryResponse = {|
  +ordersBasedOnVendorPickupScheduled: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardPickupSheduledQuery = {|
  variables: VendorDashboardPickupSheduledQueryVariables,
  response: VendorDashboardPickupSheduledQueryResponse,
|};
*/


/*
query VendorDashboardPickupSheduledQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardPickupSheduledQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "ordersBasedOnVendorPickupScheduled",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "VendorDashboardPickupSheduledQuery",
    "id": null,
    "text": "query VendorDashboardPickupSheduledQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorPickupScheduled(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '8e958edff1d39e36f04818286bb79793';
module.exports = node;
