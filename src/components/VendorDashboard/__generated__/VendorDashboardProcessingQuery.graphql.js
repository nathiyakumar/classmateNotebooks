/**
 * @flow
 * @relayHash 22eda3a7b3336faa4dae967185bc8314
 */
...
export type VendorDashboardProcessingQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardProcessingQueryResponse = {|
  +ordersBasedOnVendorProcessing: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardProcessingQuery = {|
  variables: VendorDashboardProcessingQueryVariables,
  response: VendorDashboardProcessingQueryResponse,
|};
*/


/*
query VendorDashboardProcessingQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardProcessingQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "ordersBasedOnVendorProcessing",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "VendorDashboardProcessingQuery",
    "id": null,
    "text": "query VendorDashboardProcessingQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorProcessing(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'a41bcc1e6bd55e61fdddf2158dad2f72';
module.exports = node;
