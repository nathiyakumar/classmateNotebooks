/**
 * @flow
 * @relayHash 223656900f7578858fe3f35aa27af639
 */
...
export type VendorDashboardReadyToShipQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardReadyToShipQueryResponse = {|
  +ordersBasedOnVendorReadyToShip: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardReadyToShipQuery = {|
  variables: VendorDashboardReadyToShipQueryVariables,
  response: VendorDashboardReadyToShipQueryResponse,
|};
*/


/*
query VendorDashboardReadyToShipQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardReadyToShipQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "ordersBasedOnVendorReadyToShip",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "VendorDashboardReadyToShipQuery",
    "id": null,
    "text": "query VendorDashboardReadyToShipQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorReadyToShip(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'bb1da21208c5722c45fcc77aa32adb2a';
module.exports = node;
