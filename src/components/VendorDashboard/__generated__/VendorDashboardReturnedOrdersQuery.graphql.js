/**
 * @flow
 * @relayHash bb765909734afab21068e363da30106e
 */
...
export type VendorDashboardReturnedOrdersQueryVariables = {|
  end: number,
  paginationValue?: ?number,
  sortOrder?: ?SortValueEnum,
|};
export type VendorDashboardReturnedOrdersQueryResponse = {|
  +ordersBasedOnVendorReturns: ?{|
    +pageRange: ?number,
  ...
  |}
|};
export type VendorDashboardReturnedOrdersQuery = {|
  variables: VendorDashboardReturnedOrdersQueryVariables,
  response: VendorDashboardReturnedOrdersQueryResponse,
|};
*/


/*
query VendorDashboardReturnedOrdersQuery(
  $end: Int!
  $paginationValue: Int
  $sortOrder: SortValueEnum
) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "VendorDashboardReturnedOrdersQuery",
    "type": "Query",
    "metadata": null,
    ...
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
        "name": "ordersBasedOnVendorReturns",
        "storageKey": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "VendorDashboardReturnedOrdersQuery",
    "id": null,
    "text": "query VendorDashboardReturnedOrdersQuery(\n  $end: Int!\n  $paginationValue: Int\n  $sortOrder: SortValueEnum\n) {\n  ordersBasedOnVendorReturns(end: $end, paginationValue: $paginationValue, sortOrder: $sortOrder) {\n    pageRange\n    totalRecordCount\n    orderData {\n      order {\n        id\n        orderId\n        created\n        approvedDate\n        myTotal\n        userEmail\n        shippingAddress {\n          firstName\n          phone\n          id\n        }\n        vendorLines {\n          id\n          productName\n          productSku\n          quantity\n        }\n      }\n      vendor {\n        vendor {\n          firstName\n          id\n        }\n        id\n      }\n      lineShipping(first: 10) {\n        edges {\n          node {\n            id\n            vendorProductTypeIsCustomizable\n            shippingStatus\n            dimensions\n          }\n        }\n      }\n      id\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '24cb14120e0656b31bdca9d636105213';
module.exports = node;
