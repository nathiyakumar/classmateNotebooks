/**
 * @flow
 * @relayHash c85089ff32687d37765379d875b59c79
 */
...
export type CreateAddMobileCanvasToCartCustomiserMutationVariables = {|
  userDesignId: string,
  checkoutId: string,
  inputDictionary: any,
  specification: any,
|};
export type CreateAddMobileCanvasToCartCustomiserMutationResponse = {|
  +customizerData: ?{|
    +checkout: ?{|
      +id: string,
      +lines: ?$ReadOnlyArray<?{|
  ...
  |}
|};
export type CreateAddMobileCanvasToCartCustomiserMutation = {|
  variables: CreateAddMobileCanvasToCartCustomiserMutationVariables,
  response: CreateAddMobileCanvasToCartCustomiserMutationResponse,
|};
*/
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "CreateAddMobileCanvasToCartCustomiserMutation",
    "type": "Mutation",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "CreateAddMobileCanvasToCartCustomiserMutation",
    "id": null,
    "text": "mutation CreateAddMobileCanvasToCartCustomiserMutation(\n  $userDesignId: String!\n  $checkoutId: String!\n  $inputDictionary: JSONString!\n  $specification: JSONString!\n) {\n  customizerData(userDesignId: $userDesignId, checkoutId: $checkoutId, inputDictionary: $inputDictionary, specification: $specification) {\n    checkout {\n      id\n      lines {\n        id\n        quantity\n        variant {\n          id\n          sku\n          name\n          priceOverride\n          images {\n            url\n            id\n          }\n          stockQuantity\n          product {\n            productType {\n              name\n              id\n            }\n            id\n          }\n        }\n      }\n      subtotalPrice\n      totalPrice\n      checkoutQuantity\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '81332670b7ee9672240690fb896326d0';
module.exports = node;
