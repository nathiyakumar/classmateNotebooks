/**
 * @flow
 * @relayHash 3be4b5c8af5a1a2d941331eabaa08a40
 */
...
export type CreateAddToCartCustomiserMutationVariables = {|
  userDesignId: string,
  checkoutId: string,
  inputDictionary: any,
  specification: any,
|};
export type CreateAddToCartCustomiserMutationResponse = {|
  +customizerData: ?{|
    +checkout: ?{|
      +id: string,
      +lines: ?$ReadOnlyArray<?{|
  ...
  |}
|};
export type CreateAddToCartCustomiserMutation = {|
  variables: CreateAddToCartCustomiserMutationVariables,
  response: CreateAddToCartCustomiserMutationResponse,
|};
*/
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "CreateAddToCartCustomiserMutation",
    "type": "Mutation",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "CreateAddToCartCustomiserMutation",
    "id": null,
    "text": "mutation CreateAddToCartCustomiserMutation(\n  $userDesignId: String!\n  $checkoutId: String!\n  $inputDictionary: JSONString!\n  $specification: JSONString!\n) {\n  customizerData(userDesignId: $userDesignId, checkoutId: $checkoutId, inputDictionary: $inputDictionary, specification: $specification) {\n    checkout {\n      id\n      lines {\n        id\n        quantity\n        variant {\n          id\n          sku\n          name\n          priceOverride\n          images {\n            url\n            id\n          }\n          stockQuantity\n          product {\n            productType {\n              name\n              id\n            }\n            id\n          }\n        }\n      }\n      subtotalPrice\n      totalPrice\n      checkoutQuantity\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '2e74e6d7579951656fc4cb14c780120a';
module.exports = node;
